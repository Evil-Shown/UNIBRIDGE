...
const USER_EMAIL = "nethmika@example.com";
...
function AlertsPage() {
  ...
  useEffect(() => {
    const fetchAlerts = async () => {
      try {
        setIsLoading(true);
        const response = await getAlerts(USER_EMAIL);
  ...
  const allVisibleSelected =
    ...
    filteredAlerts.every((alert) => selectedIds.includes(alert._id));
  ...
  const handleSelectAllVisible = () => {
    if (allVisibleSelected) {
      setSelectedIds((prev) =>
        prev.filter((id) => !filteredAlerts.some((alert) => alert._id === id))
      );
    } else {
  ...
  const handleDeleteSelected = async () => {
    ...
    try {
      ...
      console.error("Failed to delete selected alerts:", err);
  ...
  const handleMarkAllAsRead = async () => {
    try {
      await markAllAlertsAsRead(USER_EMAIL);
      setAlerts((prev) =>
        prev.map((alert) => ({
          ...alert,
          isRead: true,
      ...
      <section className="alerts-main-section">
        <div className="alerts-main-container">
          <div className="alerts-stats-grid">
            ...
            <div className="alerts-stat-card">
              <div className="alerts-stat-icon alt">
                <FaRegBell />
              </div>
              <div>
                <p>Unread</p>
            ...
            <div className="alerts-stat-card">
              <div className="alerts-stat-icon third">
                <FaCheckCircle />
              </div>
              <div>
                <p>Read</p>
          ...
          <div className="alerts-panel">
            <div className="alerts-panel-top">
              <div className="alerts-panel-heading">
                <h2>Inbox</h2>
                <p>Manage your employer alerts and application-related messages.</p>
              </div>
                  ...
                  >
                    <div className="alert-row-left">
                      <label className="alert-checkbox">
                        <input
                          ...
                          onChange={() => handleSelectOne(alert._id)}
                    ...
                    <div className="alert-row-actions">
                      <button
                        ...
                        onClick={() => handleDeleteSingle(alert._id)}
          ...
          >
            ...
            <div className="application-form">
              <div className="question-card">
                <label className="question-title">Time</label>
                <p>{selectedAlert.time}</p>
              </div>

              <div className="question-card">
                <label className="question-title">Message</label>
